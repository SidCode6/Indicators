...
SEED_SERIES_TITLES = {
    ...
    'KXBALGAME': 'Basketball Africa League Game',
    'KXBBLGAME': 'Bundesliga Basketball Game',
    'KXBBSERIEAGAME': 'Italy Serie A Basketball Game',
    'KXBELGIANPLGAME': 'Belgian Pro League Game',
    'KXBOLPDIVGAME': 'Bolivia Premier Division Game',
    ...
    'KXCHALLENGERMATCH': 'Challenger ATP ',
    'KXCHLLDPGAME': 'Chile Liga de Primera Game',
    'KXCHNSLGAME': 'Chinese Super League Game',
    'KXCODGAME': 'Call of Duty Games',
    'KXCONCACAFCCUPGAME': 'CONCACAF Champions Cup Game',
    'KXCONMEBOLLIBGAME': 'CONMEBOL Libertadores Game',
    'KXCONMEBOLSUDGAME': 'CONMEBOL Sudamericana Game',
    'KXCOPADELREYGAME': 'Copa Del Rey Game',
    'KXCOPADOBRASILGAME': 'Copa do Brasil Game',
    'KXCOPPAITALIAGAME': 'Coppa Italia Game',
    'KXCOUNTYCHAMPMATCH': 'County Championship Cricket Match',
    'KXCOUPEDEFRANCEGAME': 'Coupe de France Game',
    ...
    'KXESPSUPERCUPGAME': 'Spain Super Cup Game',
    'KXEUROCUPGAME': 'EuroCup Basketball Game',
    'KXEUROLEAGUEGAME': 'Euroleague Game',
    'KXEWSLGAME': "England Women's Super League Game",
    'KXF1RACE': 'F1 Race',
    'KXFACUPGAME': 'FA Cup Game',
    'KXFIBACHAMPLEAGUEGAME': 'FIBA Champions League Game',
    'KXFIBAECUPGAME': 'FIBA Europe Cup Game',
    'KXFIBAGAME': 'FIBA Game',
    'KXFRASUPERCUPGAME': 'France Super Cup Game',
    ...
    'KXKBOGAME': 'KBO Game',
    'KXKHLGAME': 'KHL Game',
    'KXKLEAGUEGAME': 'Korea K League Game',
    'KXKNVBCUPGAME': 'KNVB Cup Game',
    ...
    'KXRUGBYGPREMMATCH': 'Gallagher Prem Match',
    'KXRUGBYMLRMATCH': 'Major League Rugby Match',
    ...
    'KXSHLGAME': 'SHL Game',
    'KXSIXNATIONSMATCH': 'Six Nations Rugby Match',
    'KXSLGREECEGAME': 'Super League Greece Game',
...
ACTIVE_LIVE_SPORTS_SERIES = [
    ...
    #
    # Maximal coverage expansion (2026-05-16, user request): all real
    # game-outcome series from the Kalshi Sports catalog that were
    # missing — major soccer leagues/cups (FA Cup, LaLiga2, UCL/UEL,
    # domestic cups, ...), WTA/ATP/Davis Cup tennis, basketball,
    # hockey, KBO/NPB baseball, NFL/UFL, AFL, rugby, esports, PLL,
    # WPL. Junk/exhibition/all-star/multi-day-Test/ambiguous excluded.
    # Each is labelled in SPORT_LABEL_RULES (full-ticker rules, so no
    # blank badges / no shadowing — verified by test_kalshi.py).
    "KXACBGAME", "KXAFCCLGAME", "KXAFCONGAME", "KXAFLGAME", "KXAHLGAME",
    "KXALLSVENSKANGAME", "KXARGPREMDIVGAME", "KXATPGAME", "KXBALGAME",
    "KXBBLGAME", "KXBBSERIEAGAME", "KXBOLPDIVGAME", "KXBSLGAME",
    "KXBUNDESLIGA2GAME", "KXCANPLGAME", "KXCBAGAME", "KXCHALLENGERMATCH",
    "KXCHLLDPGAME", "KXCHNSLGAME", "KXCONCACAFCCUPGAME", "KXCONMEBOLSUDGAME",
    "KXCOPADELREYGAME", "KXCOPADOBRASILGAME", "KXCOPPAITALIAGAME",
    "KXCOUPEDEFRANCEGAME", "KXCSGOGAME", "KXCZEFLGAME",
    "KXDANISHSUPERLIGAGAME", "KXDAVISCUPMATCH", "KXDELGAME",
    "KXDENSUPERLIGAGAME", "KXDIMAYORGAME", "KXECULPGAME",
    "KXEFLCHAMPIONSHIPGAME", "KXEFLCUPGAME", "KXEGYPLGAME",
    "KXEKSTRAKLASAGAME", "KXELHGAME", "KXESPSUPERCUPGAME", "KXEWSLGAME",
    "KXFACUPGAME", "KXFIBACHAMPLEAGUEGAME", "KXFIBAECUPGAME",
    "KXFRASUPERCUPGAME", "KXHNLGAME", "KXIIHFGAME", "KXISLGAME",
    "KXITASUPERCUPGAME", "KXITFWMATCH", "KXJBLEAGUEGAME", "KXJLEAGUEGAME",
    "KXKBLGAME", "KXKBOGAME", "KXKHLGAME", "KXKLEAGUEGAME", "KXKNVBCUPGAME",
    "KXLALIGA2GAME", "KXLIIGAGAME", "KXNCAABGAME", "KXNCAAHOCKEYGAME",
    "KXNFLGAME", "KXNPBGAME", "KXOWGAME", "KXPERLIGA1GAME", "KXPLLGAME",
    "KXQSTARSGAME", "KXRLGAME", "KXRUGBYGPREMMATCH", "KXRUGBYMLRMATCH",
    "KXRUGBYNRLMATCH", "KXSCOTTISHPREMGAME", "KXSERIEBGAME", "KXSHLGAME",
    "KXSIXNATIONSMATCH", "KXSLGREECEGAME", "KXSWISSLEAGUEGAME",
    "KXTACAPORTGAME", "KXTHAIL1GAME", "KXUCLGAME", "KXUCLWGAME",
    "KXUEFAGAME", "KXUEFANLGAME", "KXUELGAME", "KXUFLGAME",
    "KXUNITEDCUPMATCH", "KXUNRIVALEDGAME", "KXURYPDGAME", "KXUSLCUPGAME",
    "KXUSLGAME", "KXUSOPENCUPGAME", "KXVENFUTVEGAME", "KXWCGAME",
    "KXWPLGAME", "KXWTACHALLENGERMATCH", "KXWTAMATCH",
]
...
SPORT_DURATION_MINUTES = {
    ...
    "MLB": 240,
    "Baseball": 240,          # KBO / NPB (non-MLB pro baseball)
    "Football": 240,          # NFL / UFL gridiron
    "NBA": 180,
    "WNBA": 180,
    "Basketball": 180,
    "NHL": 200,
...
SPORT_LABEL_RULES = [
    ...
    # --- Maximal-coverage additions (2026-05-16). Full-ticker prefixes:
    # maximally specific so they cannot shadow / be shadowed (verified
    # by test_kalshi.py). Labels derived from the Kalshi series TITLE
    # (authoritative), not guessed. ---
    ("KXACBGAME",                 "Basketball"),
    ("KXAFCCLGAME",               "Soccer"),
    ("KXAFCONGAME",               "Soccer"),
    ("KXAFLGAME",                 "Australian Rules"),
    ("KXAHLGAME",                 "Hockey"),
    ("KXALLSVENSKANGAME",         "Soccer"),
    ("KXARGPREMDIVGAME",          "Soccer"),
    ("KXATPGAME",                 "Tennis"),
    ("KXBALGAME",                 "Basketball"),
    ("KXBBLGAME",                 "Basketball"),
    ("KXBBSERIEAGAME",            "Basketball"),
    ("KXBOLPDIVGAME",             "Soccer"),
    ("KXBSLGAME",                 "Basketball"),
    ("KXBUNDESLIGA2GAME",         "Soccer"),
    ("KXCANPLGAME",               "Soccer"),
    ("KXCBAGAME",                 "Basketball"),
    ("KXCHALLENGERMATCH",         "Tennis"),
    ("KXCHLLDPGAME",              "Soccer"),
    ("KXCHNSLGAME",               "Soccer"),
    ("KXCONCACAFCCUPGAME",        "Soccer"),
    ("KXCONMEBOLSUDGAME",         "Soccer"),
    ("KXCOPADELREYGAME",          "Soccer"),
    ("KXCOPADOBRASILGAME",        "Soccer"),
    ("KXCOPPAITALIAGAME",         "Soccer"),
    ("KXCOUPEDEFRANCEGAME",       "Soccer"),
    ("KXCSGOGAME",                "Esports"),
    ("KXCZEFLGAME",               "Soccer"),
    ("KXDANISHSUPERLIGAGAME",     "Soccer"),
    ("KXDAVISCUPMATCH",           "Tennis"),
    ("KXDELGAME",                 "Hockey"),
    ("KXDENSUPERLIGAGAME",        "Soccer"),
    ("KXDIMAYORGAME",             "Soccer"),
    ("KXECULPGAME",               "Soccer"),
    ("KXEFLCHAMPIONSHIPGAME",     "Soccer"),
    ("KXEFLCUPGAME",              "Soccer"),
    ("KXEGYPLGAME",               "Soccer"),
    ("KXEKSTRAKLASAGAME",         "Soccer"),
    ("KXELHGAME",                 "Hockey"),
    ("KXESPSUPERCUPGAME",         "Soccer"),
    ("KXEWSLGAME",                "Soccer"),
    ("KXFACUPGAME",               "Soccer"),
    ("KXFIBACHAMPLEAGUEGAME",     "Basketball"),
    ("KXFIBAECUPGAME",            "Basketball"),
    ("KXFRASUPERCUPGAME",         "Soccer"),
    ("KXHNLGAME",                 "Soccer"),
    ("KXIIHFGAME",                "Hockey"),
    ("KXISLGAME",                 "Soccer"),
    ("KXITASUPERCUPGAME",         "Soccer"),
    ("KXITFWMATCH",               "Tennis"),
    ("KXJBLEAGUEGAME",            "Basketball"),
    ("KXJLEAGUEGAME",             "Soccer"),
    ("KXKBLGAME",                 "Basketball"),
    ("KXKBOGAME",                 "Baseball"),
    ("KXKHLGAME",                 "Hockey"),
    ("KXKLEAGUEGAME",             "Soccer"),
    ("KXKNVBCUPGAME",             "Soccer"),
    ("KXLALIGA2GAME",             "Soccer"),
    ("KXLIIGAGAME",               "Hockey"),
    ("KXNCAABGAME",               "NCAA Basketball"),
    ("KXNCAAHOCKEYGAME",          "Hockey"),
    ("KXNFLGAME",                 "Football"),
    ("KXNPBGAME",                 "Baseball"),
    ("KXOWGAME",                  "Esports"),
    ("KXPERLIGA1GAME",            "Soccer"),
    ("KXPLLGAME",                 "Lacrosse"),
    ("KXQSTARSGAME",              "Soccer"),
    ("KXRLGAME",                  "Esports"),
    ("KXRUGBYGPREMMATCH",         "Rugby"),
    ("KXRUGBYMLRMATCH",           "Rugby"),
    ("KXRUGBYNRLMATCH",           "Rugby"),
    ("KXSCOTTISHPREMGAME",        "Soccer"),
    ("KXSERIEBGAME",              "Soccer"),
    ("KXSHLGAME",                 "Hockey"),
    ("KXSIXNATIONSMATCH",         "Rugby"),
    ("KXSLGREECEGAME",            "Soccer"),
    ("KXSWISSLEAGUEGAME",         "Soccer"),
    ("KXTACAPORTGAME",            "Soccer"),
    ("KXTHAIL1GAME",              "Soccer"),
    ("KXUCLGAME",                 "Soccer"),
    ("KXUCLWGAME",                "Soccer"),
    ("KXUEFAGAME",                "Soccer"),
    ...
    ("KXUELGAME",                 "Soccer"),
    ("KXUFLGAME",                 "Football"),
    ("KXUNITEDCUPMATCH",          "Tennis"),
    ("KXUNRIVALEDGAME",           "Basketball"),
    ("KXURYPDGAME",               "Soccer"),
    ("KXUSLCUPGAME",              "Soccer"),
    ("KXUSLGAME",                 "Soccer"),
    ("KXUSOPENCUPGAME",           "Soccer"),
    ("KXVENFUTVEGAME",            "Soccer"),
    ("KXWCGAME",                  "Soccer"),
    ("KXWPLGAME",                 "Cricket"),  # Women's IPL — non-priority
    ...
    # Corrected 2026-05-16: these were mislabeled "Hockey" but the Kalshi
    # series TITLES prove they are SOCCER leagues (Croatia HNL, Swiss
    # Super League, Korea K League, Czech First League, Ecuador Liga Pro,
    # Chile Liga de Primera). They were dormant (not queried) until the
    # maximal-coverage expansion added their *GAME series above.
    ("KXHNL",             "Soccer"),
...
PRE_GAME_BUFFER_MINUTES = {
    ...
    "Cricket":  150,  # raised 60->150 with the default (drift, see below)
...
# Raised 60 -> 150 (2026-05-16). Same occurrence_datetime drift that hid
# IPL also hides ordinary in-range matches on series we DO cover: e.g.
# KXELITESERIENGAME-26MAY16RBKAFK was 93% (in range) and live, but its
# occurrence_datetime was +62 min ahead, so the old 60-min window had
# not opened yet -> dropped. 150 min (matching Tennis) absorbs the
# typical ~1h Kalshi schedule drift for soccer/etc. Tradeoff: a match
# may surface up to 150 min before its nominal start if its favorite is
# already in 83-98 — acceptable and consistent with Tennis's behavior.
DEFAULT_PRE_GAME_BUFFER = 150
